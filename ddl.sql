...
create table public.personal -- Ushbu jadvalda hodimlar haqida ma'lumotlar saqlanadi (tashkilot bo'yicha JOIN qilib tekshirishda faqat organization_stir ustundan foydalanish kerak va type = 'STATE' bo'lgan tashkilotlarni olish kerak -> JOIN organization o ON o.inn = personal.organization_stir WHERE o.inn = <tashkilot_inn> o.type = 'STATE')
(
