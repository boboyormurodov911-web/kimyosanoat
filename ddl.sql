...
create table public.personal -- Ushbu jadvalda hodimlarning shaxsiy ma'lumotlari saqlanadi (Tashkilotlardagi hodimlarnining ma'lumotlarini olish uchun faqat personal_check jadvalidan foydalanish kerak)
(
...
create table public.personal_check -- Asosiy hodimlar jadvali, bu jadvalda barcha hodimlarning asosiy ma'lumotlari saqlanadi (tashkilotlar bo'yicha hodimlarni chiqarish uchun organization jadvalining inn ustuniga JOIN qilish kerak va type = 'STATE' bo'lganlarni olish kerak. Asosan shu inn raqamlar bo'yicha olinadi -> ('200002933', '200599579', '309341717', '200941518', '206887857', '203621367'))
(
    id                      bigint generated by default as identity -- Hodim ID raqami (primary key)
        primary key,
    ...
    region                  varchar(255), -- viloyat
    status                  varchar(255) -- holati ("FIRED" - ishdan bo'shatilgan, "WORKING" - ish faoliyatida, "DEKRET" - dekretda)
);
