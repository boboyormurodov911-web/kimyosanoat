...
(
    ...
    date             date, -- sana
    organization_id  bigint -- tashkilot ID raqami, organization jadvalidagi id ustuni bilan bog'langan (eng asosiy tashkilotlar id raqamlari -> 1: Navoiyazot, 2: Maxam-Chirchiq, 3: Ammofos-Maxam, 4: Dehqonobod kaliy zavodi, 5: Qizilqum fosforit kompleksi, 6: Qo‘ng‘irot soda zavodi)
