...
create table public.personal -- Ushbu jadvalda hodimlarning shaxsiy ma'lumotlari saqlanadi (Tashkiltlardagi hodimlarni barcha ma'lumotlarini olish uchun personal_check jadvalidan foydalanish kerak)
(
