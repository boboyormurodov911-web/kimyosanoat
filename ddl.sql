...
alter table public.all_investment
    owner to postgres;
...
create index idx_crop_id
    on public.crop (crop_id);

create index idx_district_code
    on public.crop (district_code);

create index idx_farmer_cad_number
    on public.crop (farmer_cad_number);

create index idx_farmer_tax_number
    on public.crop (farmer_tax_number);

create index idx_harvest_code
    on public.crop (harvest_code);

create index idx_harvest_sort_code
    on public.crop (harvest_sort_code);

create index idx_harvest_year
    on public.crop (harvest_year);

create index idx_place_code
    on public.crop (place_code);

create index idx_region_code
    on public.crop (region_code);

create index idx_watering
    on public.crop (watering);
...
alter table public.debtor_creditor1c
    owner to postgres;
...
alter table public.department_types
    owner to postgres;
...
alter table public.drivers_info
    owner to postgres;
...
alter table public.employee_type
    owner to postgres;
...
alter table public.enakladnoy_shipment_status
    owner to postgres;
...
alter table public.enaklodnoy_shipment
    owner to postgres;
...
alter table public.enaklodnoy_wagon
    owner to postgres;
...
alter table public.faktura_uz_document
    owner to postgres;

create index idx_contract
    on public.faktura_uz_document (contract);

create index idx_contractor_inn
    on public.faktura_uz_document (contractor_inn);

create index idx_created_as_datetime
    on public.faktura_uz_document (created_date_time_as_date_time);

create index idx_organization_id
    on public.faktura_uz_document (organization_id);

create index idx_organization_inn
    on public.faktura_uz_document (organization_inn);

create index idx_status
    on public.faktura_uz_document (status);

create index idx_type
    on public.faktura_uz_document (type);

create index idx_unique_id
    on public.faktura_uz_document (unique_id);
...
alter table public.faktura_uz_document_content
    owner to postgres;

create index idx_contract_number
    on public.faktura_uz_document_content (contract_number);

create index idx_owner_inn
    on public.faktura_uz_document_content (owner_inn);
...
alter table public.faktura_uz_document_content_product
    owner to postgres;
...
alter table public.faktura_uz_documnet_status
    owner to postgres;
...
alter table public.faktura_uz_params
    owner to postgres;
...
alter table public.hudud_gaz_gas_meter_info
    owner to postgres;
...
alter table public.hudud_gaz_gas_meter_readings
    owner to postgres;
...
alter table public.hudud_gaz_org_customer
    owner to postgres;
...
alter table public.investment_project_finance_info
    owner to postgres;
...
alter table public.investment_project_funding_source
    owner to postgres;
...
alter table public.investment_project_schedule_event
    owner to postgres;
...
alter table public.investment_project_statuses
    owner to postgres;
...
alter table public.legal_entity_debt
    owner to postgres;
...
alter table public.mip2hududgaz_payments
    owner to postgres;
...
alter table public.organization_bank_account_transactions
    owner to postgres;

create index idx_date_as_date
    on public.organization_bank_account_transactions (date_as_date);

create index idx_doc_id
    on public.organization_bank_account_transactions (doc_id);

create index idx_lead_id
    on public.organization_bank_account_transactions (lead_id);

create index idx_org_id
    on public.organization_bank_account_transactions (organization_id);

create index idx_rcvr_inn
    on public.organization_bank_account_transactions (rcvr_inn);

create index idx_sndr_inn
    on public.organization_bank_account_transactions (sndr_inn);

create index idx_state_id
    on public.organization_bank_account_transactions (state_id);

create index idx_transaction_type
    on public.organization_bank_account_transactions (transaction_type);
...
create index idx_included_in_saldo
    on public.organization_bank_accounts (included_in_saldo_calculation);
...
alter table public.organization_meters
    owner to postgres;
...
alter table public.product_code
    owner to postgres;
...
alter table public.product_mxik
    owner to postgres;
...
alter table public.product_tiftn_code
    owner to postgres;
...
alter table public.application_divorce
    owner to postgres;
...
alter table public.application_document_products
    owner to postgres;
...
alter table public.contract_document_articles
    owner to postgres;
...
alter table public.investment_project
    owner to postgres;
...
alter table public.legal_company_account
    owner to postgres;
...
alter table public.organization_bank_account_saldos
    owner to postgres;

create index idx_account_number
    on public.organization_bank_account_saldos (account_number);
...
alter table public.organization_partner
    owner to postgres;

create table public.personal -- Ushbu jadvalda hodimlarning shaxsiy ma'lumotlari saqlanadi (Tashkilotlarda bo'yicha hodimlarning sonini chiqarish uchun staff_position_personal jadvalidan foydalanish kerak) shtatlar soni haqida ma'lumot olish uchun personal jadvaliga join qilib kirilganda tashkilot bo'yicha faqat organization_stir ustunidan foydalanish kerak va hech qanaqa ortiqcha join qilish kerak emas
(
    ...
    academic_title          varchar(255), -- hodimning ilmiy unvoni
    awards                  varchar(255), -- hodimning mukofotlari
    birth_date              varchar(255), -- hodimning tug'ilgan sanasi
    country                 varchar(255), -- hodimning tug'ilgan mamlakati
    deputy_status           varchar(255), -- hodimning o'rinbosarlik holati
    disability              varchar(255), -- hodimning nogironlik darajasi
    document                varchar(255), -- hodimning hujjati
    education               varchar(255), -- hodimning ta'limi 
    employee_number         varchar(255), -- hodimning ishchi raqami
    expiry_date             varchar(255), -- hodimning mehnat shartnomasi muddati
    ...
    home_phone              varchar(255), -- hodimning uy telefon raqami
    img                     varchar(255), -- hodimning rasmi
    inps                    varchar(255), -- hodimning INPS raqami
    internal_phone          varchar(255), -- hodimning ichki telefon raqami
    issue_date              varchar(255), -- hodimning ishga olingan sanasi
    issued_by               varchar(255), -- hodimni ishga olgan mas'ul shaxs
    job_grade               varchar(255), -- hodimning lavozim darajasi
    last_name               varchar(255), -- hodimning familiyasi
    middle_name             varchar(255), -- hodimning otasining ismi
    military_rank           varchar(255), -- hodimning harbiy unvoni
    ...
    organization_stir       varchar(255), -- hodimning tashkiloti STIR(inn) raqami (hodimlar, ularning qarindoshlari va shtatlar haqida ma'lumot so'ralganda asosiy tanlanadigan tashkilotlar stir raqamlari -> organization_stir in ('200599579', '206887857', '200941518', '200002933', '203621367', '309341717'))
    ...
    political_affiliation   varchar(255), -- hodimning partiyaviyligi (yes/no)
    position                varchar(255), -- hodimning lavozimi
    position_count          integer, -- hodimning shu paytgacha ishlagan lavozimlari soni
    registration_date       varchar(255), -- hodimning ro'yxatga olingan sanasi
    specialization          varchar(255), -- hodimning mutaxassisligi
    stir                    varchar(255), -- hodimning STIR(inn) raqami
    work_phone              varchar(255), -- hodimning ish telefon raqami
    district_id             bigint  -- hodim yashaydigan tuman ID raqami (district jadvalining id ustuni bilan bog'langan)
        constraint fkcfqdvlv14qw2n5ui1q6gqki8j
            references public.district,
    region_id               bigint  -- hodim yashaydigan viloyat ID raqami (region jadvalining id ustuni bilan bog'langan)
        constraint fk52wxtckqgut7nx2o839p1swj2
            references public.region,
    education_level         varchar(255), -- hodimning ta'lim darajasi
    end_date                date, -- hodimning ishdan bo'shagan sanasi
    start_date              date, -- hodimning ish boshlagan sanasi
    created_at              timestamp(6), -- hodimning yaratilgan sanasi
    updated_at              timestamp(6), -- hodimning yangilangan sanasi
    military_ticket_number  varchar(255), -- hodimning harbiy chiptasi raqami
...
alter table public.department_personal
    owner to postgres;
...
alter table public.income_outcome
    owner to postgres;
...
alter table public.personal_awards
    owner to postgres;
...
alter table public.personal_document 
    owner to postgres;
...
alter table public.personal_foreign_languages
    owner to postgres;
...
alter table public.personal_salary
    owner to postgres;

create table personal_check -- Asosiy hodimlar jadvali, bu jadvalda barcha hodimlarning asosiy ma'lumotlari saqlanadi
(
    id                      bigint generated by default as identity -- Hodim ID raqami (primary key)
        primary key,
    birth_date              varchar(255), -- tug'ilgan sana
    ...
    pinfl                   varchar(255) -- passport pinfl raqami
        constraint ukgryk70kb92nfw0r8g3mgtbg4q
            unique,
    start_date              date, -- passport berilgan sana
    academic_degree         varchar(255), -- ilmiy daraja
    awards                  varchar(255), -- mukofotlar
    country                 varchar(255), -- mamlakat
    datetime_created        timestamp(6), -- ma'lumot yaratilgan sana
    datetime_updated        timestamp(6), -- ma'lumot yangilangan sana
    deputy_status           varchar(255), -- deputatlik holati
    district                varchar(255), -- tuman
    employee_number         varchar(255), -- hodim raqami
    foreign_languages       varchar(255), -- chet tillari
    home_phone              varchar(255), -- uy telefoni
    military_service_status varchar(255), -- harbiy xizmat holati
    military_ticket_number  varchar(255), -- harbiy biljet raqami
    phone_number            varchar(255), -- telefon raqami
    place_of_birth          varchar(255), -- tug'ilgan joyi
    position                varchar(255), -- lavozimi
    region                  varchar(255), -- viloyat
    status                  varchar(255) -- holati ("FIRED" - ishdan bo'shatilgan, "WORKING" - ishlayotgan, "DEKRET" - dekretda)
);

alter table personal_check
    owner to "kimyosanoat-user";
...
(
    ...
    jshshir         varchar(255), -- hujjat jshshir raqami
...
create table public.shtat -- Ushbu jadvalda tashkilotlarning shtat birliklari haqida ma'lumotlar saqlanadi
(
    id                     bigint generated by default as identity -- ID raqam (primary key)
        primary key,
...
alter table public.sold_lot
    owner to postgres;

create index idx_bargain_status
    on public.sold_lot (bargain_status);

create index idx_contract_type
    on public.sold_lot (contract_type);

create index idx_delivery_date
    on public.sold_lot (delivery_date);

create index idx_lot_id
    on public.sold_lot (lot_id);

create index idx_pay_date
    on public.sold_lot (pay_date);

create index idx_transaction_date
    on public.sold_lot (transaction_date);

create index idx_transaction_date_as_date
    on public.sold_lot (transaction_date_as_date);

create index idx_transaction_number
    on public.sold_lot (transaction_number);
...
alter table public.staff_and_technics
    owner to postgres;
...
create table public.staff_position -- Hodimlar lavozimi va shtatlar haqidagi jadval.
(
    id                bigint generated by default as identity -- ID raqam (primary key)
        primary key,
    organization_stir varchar(255), -- tashkilot STIR(inn) raqami (200599579, 206887857, 200941518, 200002933, 203621367, 309341717) 
    personal_count    integer, -- hodimlar soni
    position_name     varchar(255), -- lavozim nomi
    department_id     bigint -- bo'lim ID raqami (department jadvalining id ustuni bilan bog'langan)
        constraint fk2rccfqg11kksq37ku44aforg5
            references public.department,
    personal_limit    integer, -- shtat bo'yicha limit. Shtatlar sonini aniqlashda har doim qat'iy ravishda zavoddagi ishdan bo'shatilgan hodimlar sonini hisoblab chiqarib ushbu jadvalning personal_limit ustunidan ayirib chiqarish kerak: Birinchi - perosonal_limit ustuni hisoblanadi SELECT SUM(sp.personal_limit) FROM staff_position AS sp. Ikkinchi - bo'shatilgan hodimlar sonini aniqlash kerak: SELECT COUNT(*) FROM public.personal p WHERE p.status = 'Bo`shatilgan'. Uchinchi - ana endi ayirish bajariladi: SELECT SUM(sp.personal_limit) - (SELECT COUNT(*) FROM public.personal p WHERE p.status = 'Bo`shatilgan') FROM public.staff_position sp. Ushbu uchinchi example queryda hech qanaqa JOIN amalga oshirish kerak emas! Faqatgina personal jadvalidan ishdan bo'shatilgan hodimlar sonini hisoblab chiqarib, staff_position jadvalidagi personal_limit ustunidan ayirish kerak. Ushbu ayirish amalini har doim barqaror ravishda amalga oshirish kerak. Har ikkala jadvalda ham tashkilotlarning stir raqamlari bo'yicha filter qilish kerak.
...
alter table public.staff_position_personal
    owner to postgres;
...
alter table public.technic_type
    owner to postgres;
...
alter table public.technical_tasks
    owner to postgres;
...
alter table public.transgaz_organization
    owner to postgres;
...
alter table public.transgaz_point
    owner to postgres;
...
alter table public.transgaz_point_readings
    owner to postgres;
...
alter table public.ttn
    owner to postgres;

create index idx_transfer_id
    on public.ttn (transfer_id);

create index idx_ttn_unique_id
    on public.ttn (unique_id);
...
alter table public.user_warehouse
    owner to postgres;
...
alter table public.user_warehouse1cid
    owner to postgres;
...
alter table public.application_signers
    owner to postgres;
...
alter table public.user_1c_organization
    owner to postgres;
...
alter table public.wagon_numbers
    owner to postgres;
...
alter table public.queue_code
    owner to postgres;

alter table public.users
    add constraint fk4wnocubvav3874r2psscq42jo
        foreign key (warehouse_id) references public.warehouse;
...
alter table public.warehouse_balance
    owner to postgres;
...
alter table public.warehouse_bijra_contract
    owner to postgres;
...
alter table public.warehouse_stock_income_output
    owner to postgres;
...
alter table public.stock_income_output_detail
    owner to postgres;
...
create index warehouse_stock_income_output_index
    on public.warehouse_stock_income_output (organization_id, warehouse_id, inn, product_id, period);
...
alter table public.warehouse_transfer_migration
    owner to postgres;
...
alter table public.report_document
    owner to postgres;
