...
create table public.staff_position -- Hodimlar lavozimi va shtatlar haqidagi jadval. Zavodlardagi shtatlar sonini aniqlash uchun har doim qat'iy ravishda zavoddagi ishdan bo'shatilgan hodimlar sonini hisoblab chiqarib ushbu jadvalning personal_limit ustunidan ayirib chiqarish kerak
(
    id                bigint generated by default as identity -- ID raqam (primary key)
        primary key,
