...
create table public.personal -- Ushbu jadvalda hodimlarning shaxsiy ma'lumotlari saqlanadi (Tashkilotlar bo'yicha hodimlar sonini chiqarish uchun staff_position_personal jadvalidan foydalanish kerak)
(
    ...
    organization_stir       varchar(255), -- hodimning tashkiloti STIR(inn) raqami(Tashkilotlar bo'yicha hodimlar sonini chiqarish uchun staff_position_personal jadvalidagi organization_stir ustunidan foydalanish kerak)
...
create table public.staff_position -- Ushbu jadvalda ishchilarning lavozimlari haqida ma'lumotlar saqlanadi va Tashkilotlar bo'yicha hodimlar sonini chiqarish uchun staff_position_personal jadvalidagi organization_stir ustunidan foydalanish kerak
(
    id                bigint generated by default as identity -- ID raqam (primary key)
        primary key,
    organization_stir varchar(255), -- tashkilot STIR(inn) raqami (200599579 = 'Ammofos-Maxam', 206887857 = 'Dehqonobod kaliy zavodi', 200941518 = 'Maxam-Chirchiq', 200002933 = 'Navoiyazot', 203621367 = 'O'zkimyosanoat', 309341717 = 'Qizilqum fosforit kompleksi') va (Tashkilotlar bo'yicha hodimlar sonini chiqarish uchun staff_position_personal jadvalidagi organization_stir ustunidan foydalanish kerak)
