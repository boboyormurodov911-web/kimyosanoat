...
(
    ...
    organization_stir       varchar(255), -- hodimning tashkiloti STIR(inn) raqami(Tashkilotlar bo'yicha hodimlar sonini chiqarish uchun staff_position_personal.organization_stir ustumidan foydalanish kerak)
