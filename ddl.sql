...
create table public.personal -- Ushbu jadvalda hodimlar haqida ma'lumotlar saqlanadi (tashkilot bo'yicha JOIN qilib tekshirishda faqat organization_stir ustundan foydalanish kerak va type = 'STATE' bo'lgan tashkilotlarni olish kerak -> JOIN organization o ON o.inn = personal.organization_stir WHERE o.type = 'STATE')
(
    ...
    organization_stir       varchar(255), -- hodimning tashkiloti STIR(inn) raqami ('200599579' = '“Ammofos-Maxam” AJ', '206887857' = '“Dehqonobod kaliy zavodi” AJ', '200941518' = '“Maxam-Chirchiq” AJ', '200002933' = '“Navoiyazot” AJ', '203621367' = '"O'zkimyosanoat" AJ', '309341717' = '“Qizilqum fosforit kompleksi” MChJ')
...
create table public.relatives -- Ushbu jadvalda hodimlarning qarindoshlari haqida ma'lumotlar saqlanadi
(
    id              bigint generated by default as identity -- ID raqam (primary key)
        primary key,
