...
create table public.staff_position -- Ushbu jadvalda ishchilarning lavozimlari haqida ma'lumotlar saqlanadi (Tashkilotlardagi shtatlar sonini aniqlash uchun ushbu jadvalning personal_limit ustunidan foydalanish kerak)
(
    id                bigint generated by default as identity -- ID raqam (primary key)
        primary key,
