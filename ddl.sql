...
<<<<<<< HEAD
create table public.staff_position -- Ushbu jadvalda ishchilarning lavozimlari haqida ma'lumotlar saqlanadi (Tashkilotlardagi shtatlar sonini aniqlash uchun ushbu jadvalning personal_limit jadvalidan foydalanish kerak)
=======
create table public.staff_position -- Ushbu jadvalda ishchilarning lavozimlari haqida ma'lumotlar saqlanadi (Tashkilotlar bo'yicha hodimlar sonini chiqarishda uchun staff_position jadvalidagi organization_stir ustunidan foydalanish kerak)
>>>>>>> fddffc3a15cb60da0cc230ed0d172005f630cad2
(
    id                bigint generated by default as identity -- ID raqam (primary key)
        primary key,
