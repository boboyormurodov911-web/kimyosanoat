...
create table public.personal -- Ushbu jadvalda hodimlarning shaxsiy ma'lumotlari saqlanadi (LEKIN TASHKILOTLAR BO'YICHA HODIMLARGA OID BARCHA MA'LUMOTLAR personal_check JADVALIDAN OLINADI)
(
