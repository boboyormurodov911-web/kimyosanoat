...
(
    ...
    department_id           varchar(255), -- hodimning bo'limi ID raqami
    ...
    organization_id         bigint, -- hodimning tashkilot ID raqami, organization jadvalining id ustuni bilan bog'langan (1: Navoiyazot, 2: Maxam-Chirchiq, 3: Ammofos-Maxam, 4: Dehqonobod kaliy zavodi, 5: Qizilqum fosforit kompleksi)
    ...
    status                  varchar(255) -- hodimning ish holati ("FIRED" - ishdan bo'shatilgan, "WORKING" - ish faoliyatida, "DEKRET" - dekretda)
);
...
create table public.staff_position -- Ishchilar lavozimi va shtatlar haqidagi jadval. Hodimlar haqidagi ma'lumotlar personal_check jadvalidan olinadi!
(
    id                bigint generated by default as identity -- ID raqam (primary key)
        primary key,
