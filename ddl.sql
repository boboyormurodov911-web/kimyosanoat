...
create table public.staff_position -- Hodimlar lavozimi va shtatlar haqidagi jadval. Zavoddagi jami shtat limitini hisoblashda ushbu jadvalning personal_limit ustuni yig‘indisi olinadi. Keyin personal jadvalidan ushbu tashkilot bo‘yicha statusi Bo`shatilgan bo‘lgan hodimlar soni hisoblanadi va shu son personal_limit yig‘indisidan ayiriladi
(
    id                bigint generated by default as identity -- ID raqam (primary key)
        primary key,
