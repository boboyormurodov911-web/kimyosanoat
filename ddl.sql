...
create table public.staff_position -- Hodimlar lavozimi va shtatlar haqidagi jadval. Zavodlardagi shtatlar sonini aniqlash uchun har doim qat'iy ravishda zavoddagi ishdan bo'shatilgan hodimlar sonini hisoblab chiqarib ushbu jadvalning personal_limit ustunidan ayirib chiqarish kerak. ESLATMA: personal_limit yig'indisi uchun alohida query va ishdan bo'shatilgan hodimlar uchun alohida query yoziladi. Keyin ikkala query bitta queryda ayiriladi (personal_limit - ishdan_bo'shatilan_hodimlar)
(
    id                bigint generated by default as identity -- ID raqam (primary key)
        primary key,
